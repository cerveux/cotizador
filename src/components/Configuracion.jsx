                                ...
                                <div className="col-12">
                                    <div className=""  >
                                        <div className="row g-5 d-flex justify-content-center " >
                                            ...
                                            <div className="col-12 col-md-6 d-flex justify-content-around  flex-column p-5" >


                                                <h3 className="text-center mb-5">Valores de Matricería y Rendimiento:</h3>

                                                <div className="form-group row mb-1">
                                                    <label htmlFor="inputBorrado" className="col-sm-10 col-md-9 col-lg-10 col-form-label inter">Borrado:</label>
                                            ...
                                            <div className="col-12 col-md-6 d-flex flex-column p-5" >
                                                ...
                                                <h3 className="text-center mb-5">Precio por kg. por Tipo de Pintura:</h3>
